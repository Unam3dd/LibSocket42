...
/*   Updated: 2023/01/23 15:10:43 by stales           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*********************************************************************
*
* @brief  Constructor with void for Epoll Instance  
*
* @param    void
*
* @return    
*
*********************************************************************/
Epoll::Epoll(void): _efd(-1), _isinit(false) {}
...
{
	if ((this->_efd = epoll_create1(flags)) < 0) return ;
	this->_isinit = true;
}
